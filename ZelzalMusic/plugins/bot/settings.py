...
from ZelzalMusic.utils.decorators.admins import ActualAdminCB
from ZelzalMusic.utils.decorators.language import language, languageCB
from ZelzalMusic.utils.inline.settings import (
    auth_users_markup,
    playmode_users_markup,
    setting_markup,
    vote_mode_markup,
)
from ZelzalMusic.utils.inline.start import private_panel
from config import BANNED_USERS, OWNER_ID


@app.on_message(
    filters.command(["اع", "اعداد"], "") & filters.group & ~BANNED_USERS
)
@language
