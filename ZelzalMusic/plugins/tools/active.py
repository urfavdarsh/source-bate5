...
@app.on_message(command(["المكالمات الصوتيه", "النشط"]) & SUDOERS)
async def activevc(_, message: Message):
    mystic = await message.reply_text("» جـارِ إحضار جميـع المكالمـات الصوتيـه في البـوت...")
...
async def activevi_(_, message: Message):
    mystic = await message.reply_text("» جـارِ إحضار جميـع مكالمـات الفيديـو المرئيـه في البـوت...")
