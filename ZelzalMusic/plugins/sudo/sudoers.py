...
from ZelzalMusic.utils.database import add_sudo, remove_sudo
...
@app.on_message(command(["مط", "رفع مطور", "خد"]) & filters.user(OWNER_ID))
@language
...
@app.on_message(command(["تنز", "تنزيل مطور", "خد تاني"]) & filters.user(OWNER_ID))
@language
...
@app.on_message(command(["المطورز", "المطورين", "الي واخدين"]) & ~BANNED_USERS)
@language
