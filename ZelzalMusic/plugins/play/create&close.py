...
async def start_group_call(c: Client, m: Message):
    ...
    if assistant is None:
        ...
        return
    msg = await app.send_message(chat_id, "جاري فتح الـكول..")
    try:
        ...
        await msg.edit_text("تم فتح الـكول بنجاح 🖤")
      ...
      try:    
        ...
        await msg.edit_text("تم فتح الـكول بنجاح 🖤")
         ...
         await msg.edit_text("خلي المساعد معاه كل الصلاحيات وجرب 🖤")
...
async def stop_group_call(c: Client, m: Message):
    ...
    if assistant is None:
        await app.send_message(chat_id, "خطأ في المساعد")
        return
    msg = await app.send_message(chat_id, "جاري قفل الكول..")
    try:
        if not (
           group_call := (
               await get_group_call(assistant, m, err_msg="الكول مقفول اصلا 🖤")
           )
        ):  
           return
        await assistant.invoke(DiscardGroupCall(call=group_call))
        await msg.edit_text("تم قفل الـكول بنجاح 🖤")
